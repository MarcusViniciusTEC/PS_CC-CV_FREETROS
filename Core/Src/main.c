...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : IT_ENC_DT_Pin */
  GPIO_InitStruct.Pin = IT_ENC_DT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(IT_ENC_DT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : IT_ENC_CLK_Pin */
  GPIO_InitStruct.Pin = IT_ENC_CLK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(IT_ENC_CLK_GPIO_Port, &GPIO_InitStruct);
